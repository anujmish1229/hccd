...
const founder = {
  ...
  image: anujImg,
  bio: "Anuj Mishra is the founder of HCCD, driven by a deep commitment to building a vibrant Hindu community in Durham. With a background in community organizing and a passion for cultural preservation, Anuj leads HCCD's mission of unity and service.",
};
...
const boardMembers = [
  {
    ...
    role: "Board Member",
    image: nidhiImg,
    bio: "Nidhi brings warmth, creativity, and organizational expertise to HCCD. She leads the cultural programming committee and spearheads our women's empowerment initiatives.",
  },
  {
    name: "Mukesh Mishra",
    role: "Board Member",
    image: mukeshImg,
    bio: "Mukesh oversees HCCD's community outreach and partnerships. His dedication to seva (selfless service) has been instrumental in connecting HCCD with the broader Durham community.",
  },
];
    ...
    <main className="pt-20">
      ...
      <section className="bg-cream-dark py-20 relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <p className="font-body text-xs uppercase tracking-widest text-saffron mb-3">The People Behind HCCD</p>
      ...
      <section className="py-20 bg-cream">
        <div className="container mx-auto px-6">
          <div className="text-center mb-12">
            <p className="font-body text-xs uppercase tracking-widest text-saffron mb-3">Leadership</p>
      ...
      <section className="py-20 bg-cream-dark">
        <div className="container mx-auto px-6">
          <div className="text-center mb-12">
            <p className="font-body text-xs uppercase tracking-widest text-saffron mb-3">Governance</p>
              ...
              >
                <div className="relative">
                  <img
                    src={member.image}
                    alt={member.name}
                    className="w-full h-80 object-cover object-top" // <-- increased from h-64 to h-80
                  />
      ...
      <section className="py-20 bg-cream">
        <div className="container mx-auto px-6">
          <div className="text-center mb-12">
            <p className="font-body text-xs uppercase tracking-widest text-saffron mb-3">The Heart of HCCD</p>
            <h2 className="font-display text-4xl font-semibold text-foreground mb-4">Our Volunteers</h2>
            <p className="font-body text-muted-foreground max-w-xl mx-auto">
              Our volunteers are the backbone of HCCD. Every event, every program, every smile is made possible by their selfless dedication.
            </p>
          </div>
          ...
          <div className="relative rounded-3xl overflow-hidden shadow-[0_8px_40px_-8px_hsl(25_40%_12%/0.2)]">
            ...
            />
            <div className="absolute inset-0 bg-gradient-to-t from-brown/80 via-brown/30 to-transparent flex items-end">
              <div className="p-10 w-full">
                <h3 className="font-display text-3xl text-cream font-bold mb-2">Join Our Volunteer Family</h3>
                <p className="font-body text-cream/75 mb-6 max-w-lg">
                  Whether you can give a few hours or a few days each month, your contribution makes a real difference.
                  Together, we create something beautiful.
                </p>
                <a
                  href="/join"
                  className="inline-flex items-center gap-2 bg-gold text-brown font-body font-semibold px-7 py-3 rounded-full hover:bg-gold-light transition-colors"
                >
                  Volunteer With Us
                </a>
              </div>
